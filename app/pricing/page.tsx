  ...
  const plans = [
    {
      ...
      price: '$0',
      period: '/mo',
      description: 'Try it free — no card needed. Limited to 5 AI messages a day.',
    ...
    },
    {
      name: 'Pro',
      price: '$29.99',
      period: '/mo · less than $1/day',
      description: 'Unlimited AI for creators who are serious about growing.',
      features: [
        'Unlimited AI messages',
        'Clarity Score & weekly reports',
        'Spreadsheet generator',
        'Content Brief & Post Schedule',
      ],
    ...
    },
    {
      ...
      price: '$59.99',
      period: '/mo',
      description: 'Everything, plus priority AI and early access to new features.',
      features: [
        'Everything in Pro',
